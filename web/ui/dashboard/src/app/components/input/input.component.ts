...
@Directive({
	...
	standalone: true,
	host: {
		class: 'transition-all duration-[.3s] w-full font-normal text-14 placeholder:text-gray-300 placeholder:text-opacity-[.48] placeholder:font-light text-gray-800 border border-primary-500 valid:border-primary-500 disabled:text-grey-40 disabled:border-primary-500 disabled:bg-[#F7F9FC] hover:bg-primary-25 hover:border-grey-20 focus:border-primary-100 focus:bg-white-100 outline-none rounded-4px bg-[#F7F9FC] py-12px px-16px appearance-none',
