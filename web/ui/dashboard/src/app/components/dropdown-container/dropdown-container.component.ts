...
@Directive({
	...
	standalone: true,
	host: { class: 'absolute top-[110%] w-full bg-white-100 border border-primary-25 rounded-12px shadow-default z-10 transition-all ease-in-out duration-300 h-fit max-h-[440px]', '[class]': 'classes' }
})
